...
elseif (T>600 || T<3500) || (P>20 || P<30000)
    ...
    fprintf(' dvdt = %8.2e \n', dvdT );
    fprintf(' dvdp = %8.2e \n', dvdP );
    [T,T2,P_crank]=CrankAngleCalcs(rc,re,thetas,thetad,a,n,b,stroke,len,Cp,MW,dMdT,h,R,dMdP,v,P);
else
...
[m1,m2]=WoschniHeatTransfer(T2,P_crank);
plot(-180:.1:179.9,m1)
title('Mass flow rate vs crank angle')
ylabel('Mass flow rate (kg/s)')
ylabel('Crank angle (theta)')