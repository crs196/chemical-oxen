%% Miller Cycle - The Chemical Oxen - Thermo Team 
% Sourcing: https://www.mathworks.com/matlabcentral/fileexchange/72686-internal-combustion-engines
%%% Combustion report
% submitted to:Prof.Osama el Bahar
% submitted by :Omar Ahmed Mohamed
% sec:3
% B.N.:7
%% constants
close all
clear all
clc
s=8.90179600020877; %stroke in meters
r=s/2; % radius
l=4*s; % connecting rod length
tmax=3000; %peak temperature in K
...
p=101325;%inlet pressure 101kPA
t=27+273;%inlet temperature 300K
